  ...
  return (
    ...
    >
      <VStack spacing={8} align="center" justify="center" h="full">
        ...
        >
          <Heading as="h1" size="2xl" mb={4}>Detective Game</Heading>
          <Text>Story Background: [Insert story background here]</Text>
          <Text mt={4}>The Death: [Insert information about the death]</Text>
          <Text mt={4}>Method of Murder: [Insert how the death was killed]</Text>
          <Text mt={4}>Suspects Introduction: [Insert brief intro to suspects]</Text>
        </Box>

        {/* Action Buttons */}
        <Box display="flex" justifyContent="center" gap={4} w="full">
          <Button leftIcon={<FiSearch />} colorScheme="purple" size="lg" width="200px">
            Inquire Suspects
          </Button>
          <Button leftIcon={<FiEye />} colorScheme="green" size="lg" width="200px">
            Investigate Scene
          </Button>
          <Button leftIcon={<FiHelpCircle />} colorScheme="orange" size="lg" width="200px">
            Ask for Hint
          </Button>
        </Box>
      </VStack>
